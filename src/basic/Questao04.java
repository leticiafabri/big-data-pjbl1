...
//Transações por FLOW
    ...
    public static class Map extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        public void map(LongWritable key, Text value, Context con)
            ...
            // Ignora flow vazio
            if (flow.trim().isEmpty()) {
                return;
            }

            flowText.set(flow);

            con.write(flowText, one);
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job j = Job.getInstance(conf, "Questao04");

        j.setJarByClass(Questao04.class);
        ...
        FileOutputFormat.setOutputPath(j,
                new Path("output/resultado_questao04"));
        ...
        if (sucesso) {
            ...
            Files.copy(
                    Paths.get("output/resultado_questao04/part-r-00000"),
                    Paths.get("output/resultado-04.txt"),
                    StandardCopyOption.REPLACE_EXISTING
            );

            System.out.println("Resultado salvo em output/resultado-04.txt");
        }
